...
import { Frustum, Scene, WebGLRenderer, PerspectiveCamera, Vector2, Vector3 } from 'three';
...
export default class PanoViewer {
    ...
    constructor(element: HTMLElement, opt?: RenderConfig) {
        ...
        (window as any).RACE(opt?.projectId,()=>canrender=true,()=>this.controls.enableRotate = false);
        canrender=true
    ...
    async loadPanoById(id: string, firstload?: boolean,movetime=0,fadetime=0) {
    ...
    async loadPano(panodata: any, firstload?: boolean,movetime=0,fadetime=0) {
